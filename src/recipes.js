export const recipes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "ผงชาไทย (1 ช้อน)",
      "MBS (4 ปั๊ม)",
      "นมสด (ฟองนม 50ml)", // อ้างอิงจากรูปชั้นนม
      "น้ำแข็งแก้ว 22oz"
    ]
  },
  {
  ...
  },
  {
    ...
    category: "Iced (16oz)",
    ingredients: [
      "ไข่มุกบุก (2 ช้อนโต๊ะ)", // ใส่ล่าง+บน
      "นมสด (5 oz)",
      "MBS (3 ปั๊ม)",
...
// รวบรวมวัตถุดิบทั้งหมดสำหรับทำปุ่มกด (ตัดซ้ำออกให้แล้ว)
